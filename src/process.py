...
from tennis_statistics import Statistics
...
def main():
    s = time.time()
    video_process(video_path='./VideoInput/video_input8.mp4', show_video=True, stickman=True, stickman_box=False, smoothing=True,
